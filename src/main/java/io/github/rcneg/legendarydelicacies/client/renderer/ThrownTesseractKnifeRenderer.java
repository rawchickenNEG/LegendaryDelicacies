...
@OnlyIn(Dist.CLIENT)
public class ThrownTesseractKnifeRenderer extends EntityRenderer<ThrownTesseractKnifeEntity> {
    private final ItemRenderer itemRenderer;
    private final float scale;

    public ThrownTesseractKnifeRenderer(EntityRendererProvider.Context p_174416_, float p_174417_) {
        super(p_174416_);
        this.itemRenderer = p_174416_.getItemRenderer();
        this.scale = p_174417_;
    }

    public ThrownTesseractKnifeRenderer(EntityRendererProvider.Context p_174414_) {
        this(p_174414_, 1.5F);
    }

    protected int getBlockLightLevel(ThrownTesseractKnifeEntity p_116092_, BlockPos p_116093_) {
        return 15;
    }

    public void render(ThrownTesseractKnifeEntity p_116085_, float p_116086_, float p_116087_, PoseStack p_116088_, MultiBufferSource p_116089_, int p_116090_) {
    ...
    public ResourceLocation getTextureLocation(ThrownTesseractKnifeEntity p_116083_) {
