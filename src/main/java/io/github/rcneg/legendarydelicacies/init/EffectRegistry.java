...
public class EffectRegistry {
    ...
    public static final RegistryObject<MobEffect> PERSEVERING_SOUL = MOB_EFFECTS.register("persevering_soul", () -> new LMDImmunityMobEffect(MobEffectCategory.BENEFICIAL, -9999028, List.of(ModEffects.SOUL_FRACTURE.get())));
    public static final RegistryObject<MobEffect> ATOM_ANNIHILATION = MOB_EFFECTS.register("atom_annihilation", () -> new LMDImmunityMobEffect(MobEffectCategory.BENEFICIAL, -9999028, List.of(ModEffects.ANNIHILATION.get())));
    ...
    public static final RegistryObject<MobEffect> LIGHTNING = MOB_EFFECTS.register("thunderstruck", () -> new LMDMobEffect(MobEffectCategory.BENEFICIAL, -9999028));
    public static final RegistryObject<MobEffect> FLAWLESS = MOB_EFFECTS.register("flawless", () -> new FlawlessEffect(MobEffectCategory.BENEFICIAL, -9999028));
    ...
    public static final RegistryObject<MobEffect> FLYING = MOB_EFFECTS.register("flying", () -> new FlyingEffect(MobEffectCategory.BENEFICIAL, -9999028));
    ...
    public static final RegistryObject<MobEffect> POSSESSED_SOUL = MOB_EFFECTS.register("possessed_soul", () -> new PossessedSoulEffect(MobEffectCategory.NEUTRAL, -9999028));
    public static final RegistryObject<MobEffect> RECONSTRUCTION = MOB_EFFECTS.register("reconstruction", () -> new LMDMobEffect(MobEffectCategory.BENEFICIAL, -9999028));
    public static final RegistryObject<MobEffect> LIFE_FRACTURE = MOB_EFFECTS.register("life_fracture", () -> new LifeFractureEffect(MobEffectCategory.HARMFUL, -9999028));
